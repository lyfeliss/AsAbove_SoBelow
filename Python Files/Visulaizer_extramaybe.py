...
SERIAL_PORT = "COM9"  # e.g., "COM3" on Windows
BAUD_RATE = 115200
...
def quaternion_to_axis_up(q):
    ...
    This version does not invert the x component, so that the identity
    quaternion produces an axis of (1, 0, 0) and up of (0, 1, 0).
    """
    w, x, y, z = q
